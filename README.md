...
> **Kenapa beda dari Moka/Olsera/Pawoon (299k/bln/outlet)?** Data di HP sendiri, APK 74M ringan, jalan di Android 10, struk thermal 58/80mm + PDF A4, logo toko PNG, tanpa watermark/batas produk.
...
- **v1.4.3 (10)** — Fix ikon kotak-kotak (outline valid), splash loading navy, logo PNG di struk, pilih kertas 58/80/A4
